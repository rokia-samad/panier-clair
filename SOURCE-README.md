# Panier Etiq 0.3.0 — source build instructions for AMO reviewers
...
The generated `content.js` should match the file in the submitted `panier-etiq-0.3.0-unsigned.xpi`. The XPI is written to `dist/` by the last command. No generated files are included in this source archive.
